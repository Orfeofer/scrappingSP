...
departamentos = ['congelados']
categorias = ['hamburguesas-nuggets-y-apanados', 'enrollados', 'pescados-congelados', 'mariscos-congelados', 'frutas-congeladas', 
                'verduras-congeladas', 'panes-pastas-bocaditos-y-salsas', 'helados-y-postres', 'hielo']
...
for elemento in categorias:
    ...
    link = f"https://www.plazavea.com.pe/congelados/{elemento}"
...
data3 = pd.DataFrame({"cod_producto": codigo_series,
...
data3.to_excel("DataProductos3.xlsx", index = False)